...
const project = {
  ...
  year: '2023',
  client: 'AVA',
  description: 'A dynamic product launch campaign for AVA\'s innovative Advanced Recovery solution.',
  heroImage: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/ava%20advanced%20recovery%20-%20launch.jpg-8Jzjq9h9kUMHHFpcZwQusaFM4gKU3Y.jpeg',
}

export default function AVAAdvancedRecoveryProjectPage() {
      ...
      <div className="container mx-auto px-4 pt-24 pb-20">
        ...
        >
          ...
          <footer className="bg-black text-white/50 text-center py-4 mt-16">
            <p className="text-sm">
              © {new Date().getFullYear()} AVA Advanced Recovery. All rights reserved.
            </p>
          </footer>
        </motion.div>
      </div>
