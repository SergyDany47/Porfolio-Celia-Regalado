...
const project = {
  ...
  description: 'An exciting tourism campaign showcasing the vibrant attractions and experiences of Dubai.',
  heroImage: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/real%20madrid%20x%20visit%20dubai.jpg-UAvRZY5zW91UcxvD3XmBhZkzcMOtCO.jpeg',
}

export default function VisitDubaiProjectPage() {
      ...
      <div className="container mx-auto px-4 pt-24 pb-20">
        ...
        >
          ...
          <footer className="bg-black text-white/50 text-center py-4 mt-16">
            <p className="text-sm">
              © {new Date().getFullYear()} Visit Dubai. All rights reserved.
            </p>
          </footer>
        </motion.div>
      </div>
