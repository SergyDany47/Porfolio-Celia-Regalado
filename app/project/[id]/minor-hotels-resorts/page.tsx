...
const project = {
  ...
  year: '2023',
  client: 'Minor Hotels',
  description: 'A luxurious campaign showcasing the elegance and comfort of Minor Hotels & Resorts.',
  heroImage: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/minor%20hotels%20&%20resorts.jpg-uaVqiyyUn9YILJcX1noVrLbQjNnuXk.jpeg',
}

export default function MinorHotelsResortsProjectPage() {
      ...
      <div className="container mx-auto px-4 pt-24 pb-20">
        ...
        >
          ...
          <footer className="bg-black text-white/50 text-center py-4 mt-16">
            <p className="text-sm">
              © {new Date().getFullYear()} Minor Hotels & Resorts. All rights reserved.
            </p>
          </footer>
        </motion.div>
      </div>
